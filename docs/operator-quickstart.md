# Operator Quickstart — cloud-itonami-isic-6311

Shortest path from clone to a verified local dry-run for **ISIC 6311** (`cloud-itonami-isic-6311`).
...
```bash
git clone https://github.com/cloud-itonami/cloud-itonami-isic-6311.git
